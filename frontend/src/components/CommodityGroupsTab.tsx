            ...
            <form onSubmit={handleSave}>
              ...
              <div className="form-group">
                ...
                <select 
                  ...
                  disabled={groupForm.approvalStatus !== 'APPROVED'}
                  style={groupForm.approvalStatus !== 'APPROVED' ? { backgroundColor: 'var(--bg-hover)', color: 'var(--text-muted)', cursor: 'not-allowed' } : {}}
                >
